...
export function ScenesShowcase() {
  ...
  const { selectedStyleId, selectedSceneId } = useScrollSection()
  ...
  // Update images when selected style or scene changes
  useEffect(() => {
  ...
  const getParallaxStyle = (index: number): React.CSSProperties => {
    ...
    const parallaxSpeeds = [
      -120, // Image 0: Move up
      120,  // Image 1: Move up slower
      140,  // Image 2: Move down
      -100,  // Image 3: Move down slower
      -60,  // Image 4: Move up slow
      90    // Image 5: Move down medium
    ]
  ...
  return (
    <div ref={sectionRef}>
      ...
      className={`${cssStyles.container} ${cssStyles.gradientAbyss}`}
      panelId="scenes"
    >
      <div>
        {/* Section Title */}
        ...
        {/* Scene Images */}
        {!isLoading && randomImages.length >= 6 && (
          <div className={cssStyles.floatingImagesContainer}>
            {/* Scene 1 - Top Left */}
            <div className={cssStyles.sceneImage1 + ' ' + cssStyles.floatingImage} style={getParallaxStyle(0)}>
              <div className={`relative w-32 h-32 md:w-40 md:h-40 ${cssStyles.imageWrapperRing30}`}>
                <Image
                  src={randomImages[0]}
            ...
            {/* Scene 2 - Top Right */}
            <div className={cssStyles.sceneImage2 + ' ' + cssStyles.floatingImage} style={getParallaxStyle(1)}>
              <div className={`relative w-36 h-36 md:w-44 md:h-44 ${cssStyles.imageWrapperRing30}`}>
                <Image
                  src={randomImages[1]}
                  alt="Scene background"
                  fill
            ...
            {/* Scene 3 - Middle Left */}
            <div className={cssStyles.sceneImage3 + ' ' + cssStyles.floatingImage} style={getParallaxStyle(2)}>
              <div className={`relative w-28 h-28 md:w-36 md:h-36 ${cssStyles.imageWrapperRing30}`}>
                <Image
                  src={randomImages[2]}
                  alt="Scene background"
                  fill
            ...
            {/* Scene 4 - Middle Right */}
            <div className={cssStyles.sceneImage4 + ' ' + cssStyles.floatingImage} style={getParallaxStyle(3)}>
              <div className={`relative w-32 h-32 md:w-40 md:h-40 ${cssStyles.imageWrapperRing30}`}>
                <Image
                  src={randomImages[3]}
                  alt="Scene background"
            ...
            {/* Scene 5 - Bottom Center Left */}
            <div className={cssStyles.sceneImage5 + ' ' + cssStyles.floatingImage} style={getParallaxStyle(4)}>
              <div className={`relative w-32 h-32 md:w-[14rem] md:h-[14rem] ${cssStyles.imageWrapperRing30}`}>
                <Image
                  src={randomImages[4]}
                  alt="Scene background"
                  fill
            ...
            {/* Scene 6 - Bottom Right */}
            <div className={cssStyles.sceneImage6 + ' ' + cssStyles.floatingImage} style={getParallaxStyle(5)}>
              <div className={`relative w-28 h-28 md:w-36 md:h-36 ${cssStyles.imageWrapperRing30}`}>
                <Image
                  src={randomImages[5]}
                  alt="Scene background"
