      ...
      <div 
          ...
          <div className="space-y-8 pt-16">
            ...
            <div className="flex flex-col space-y-8 max-w-xs">
              ...
              <div className="text-sm flex flex-col gap-2">
                <p className="font-regular text-frost animate-fade-in-up-delay-3">The most advanced <span className="text-glacier font-medium px-1 py-0.5 bg-glacier/10 rounded-sm">AI</span> headshots. <span className="font-medium">Period.</span></p>
                <p className="font-medium leading-[1.2] text-frost/60 animate-fade-in-up-delay-4">Make your first impression count. Transform everyday selfies into standout headshots, personalised to you and ready in minutes.</p>
              </div>
            </div>
        ...
        <div className="flex flex-col h-full min-h-dvh md:h-auto md:min-h-0 w-full md:w-1/2 lg:w-1/3 p-4 pb-2 sm:p-8 sm:pb-6 lg:p-12 lg:pb-6 items-end justify-end space-y-8">
          ...
          <div className="flex flex-col flex-1 select-none">
            <Image 
              src="/photo-meta.svg" 
              alt="Photo metadata visualization"
              width={280}
              height={280}
          ...
          <div className="w-16 h-16 rounded-full p-[3px] border-2 border-white/80 select-none">
            <button
              onClick={() => webGLRef.current?.transition()}
          ...
          <p className="text-frost/40 text-sm font-medium text-justify tracking-tight leading-[1.2] pb-3">
            We&apos;ve forgotten the art of showing up at our best. We snap a selfie, tweak the angle, and hope it&apos;s enough to make a mark. In a world that scrolls fast and judges faster, you need a photo that speaks—clearly, confidently, and with purpose.
          </p>
          <p className="text-frost/40 text-sm font-medium text-justify tracking-tight leading-[1.2] pb-3">
            Primeshot transforms your everyday photos into premium headshots, brimming with style and personality. No stiff poses. No awkward photoshoots. Just authentic, scroll-stopping portraits delivered in minutes.
          </p>
          <p className="text-frost/60 text-sm font-bold text-justify tracking-tight leading-[1.2]">
            Shine as you are—with bold ambition.
          </p>
          </div>
