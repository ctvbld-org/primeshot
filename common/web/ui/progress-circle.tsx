...
export function ProgressCircle({ percentage, size = 36, strokeWidth = 2, trackColor = 'transparent', color = '#2ADED8', className, ariaLabel, direction = 'fill', clockwise = false }: ProgressCircleProps) {
  ...
  return (
    <svg
      ...
      height={size}
      className={className}
      style={{ transform: clockwise ? 'rotateZ(270deg)' : 'rotateZ(270deg) rotateX(180deg)' }}
      role="progressbar"
      aria-valuemin={0}
      aria-valuemax={100}
      aria-valuenow={pct}
