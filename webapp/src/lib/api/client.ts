...
export function getApiUrl(path: string): string {
  ...
  // In production (when basePath is set), Next.js automatically handles the prefix
  // We don't need to manually add it - Next.js will resolve relative paths correctly
  return `/${cleanPath}`
}
