        ...
        <div className={styles.specialOfferBanner}>
          <div className={styles.bannerContainer}>
            ...
            <div className={styles.bannerRight}>
              <p className={styles.bannerDescription}>{tp('subscription.banner.description.start')}  <span style={{ backgroundColor: '#FF491C', color: '#fff', padding: '4px 6px', borderRadius: '3px 0 0 3px', whiteSpace: 'nowrap' }}>{tp('subscription.banner.description.lifetime')}</span><span style={{ backgroundColor: '#FFF', color: '#FF491C', padding: '4px 6px', borderRadius: '0 3px 3px 0', whiteSpace: 'nowrap' }}> {tp('subscription.banner.description.annualDiscount')}</span>  {tp('subscription.banner.description.annualWord')} {tp('subscription.banner.description.or')} <span style={{ backgroundColor: '#FFF', color: '#FF491C', padding: '4px 6px', borderRadius: '3px', whiteSpace: 'nowrap' }}>{tp('subscription.banner.description.monthlyDiscount')}</span> {tp('subscription.banner.description.monthlyWord')}, {tp('subscription.banner.description.end')}</p>
