...
import styles from '@/components/upload/upload-requirements.module.css'
import { UPLOAD_CONSTANTS } from '@/lib/constants/upload'

interface UploadRequirementsStepProps {
...
export function UploadRequirementsStep({ onScrollToBottom }: UploadRequirementsStepProps) {
  ...
  return (
    <div ref={containerRef} className={cn(styles.container, styles.visible)}>
