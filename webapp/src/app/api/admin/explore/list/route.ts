...
import { ListExploreImagesResponse, ExploreImageWithRelations } from '@primeshot/common/types';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      return NextResponse.json<ListExploreImagesResponse>(
    ...
    return NextResponse.json<ListExploreImagesResponse>({
      success: true,
      images: enrichedImages as ExploreImageWithRelations[],
      groupedByStyle
    });
