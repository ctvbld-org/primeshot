...
function cdnAsset(path: string): string {
  const base = (Deno.env.get("NEXT_PUBLIC_AWS_DISTRIBUTION") || Deno.env.get("AWS_CDN_BASE") || "").replace(/\/$/, "");
  return `${base}/${path}`;
}
    ...
    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#000;margin:0 auto;max-width:600px;width:100%">
      <tbody><tr><td>
        <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" class="sm_px-40px" style="padding:0 20px">
          <tbody><tr><td>
            <img alt="Primeshot" src="${cdnAsset("website-images/email/base-primeshot-logo.png")}" style="width:74px;height:74px;object-fit:cover;margin:40px 0;display:block;border:0" />
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:40px"><tbody><tr><td>
              <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:24px"><tbody><tr>
                ...
                <td style="min-width:60px;text-align:right;vertical-align:top"><table cellpadding="0" cellspacing="0" style="width:100%"><tr><td style="text-align:right;padding-bottom:4px"><img alt="Photo Styles" src="${cdnAsset("website-images/email/welcome-01.png")}" style="width:48px;height:48px;object-fit:cover;display:block;border:0" /></td><td style="text-align:right;padding-bottom:4px"><img alt="Scenes" src="${cdnAsset("website-images/email/welcome-02.png")}" style="width:48px;height:48px;object-fit:cover;display:block;border:0" /></td><td style="text-align:right"><img alt="Wardrobe" src="${cdnAsset("website-images/email/welcome-03.png")}" style="width:48px;height:48px;object-fit:cover;display:block;border:0" /></td></tr></table></td>
              </tr></tbody></table>
              ...
              <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:24px"><tbody><tr>
                ...
                <td style="width:48px;text-align:right;vertical-align:top"><img alt="Character" src="${cdnAsset("website-images/email/welcome-04.png")}" style="width:48px;height:48px;object-fit:cover;display:block;border:0" /></td>
              </tr></tbody></table>
              ...
              <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:24px"><tbody><tr>
                ...
                <td style="width:48px;text-align:right;vertical-align:top"><img alt="Generate" src="${cdnAsset("website-images/email/welcome-05.png")}" style="width:48px;height:48px;object-fit:cover;display:block;border:0" /></td>
              </tr></tbody></table>
            </td></tr></tbody></table>

        <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="padding:0 20px"><tbody><tr><td>
          <img alt="Founding 300" src="${cdnAsset("website-images/email/welcome-06.png")}" style="width:100%;height:auto;object-fit:cover;margin-bottom:20px;display:block;border:0" />
        ...
        <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
          <img alt="Preview Shots" src="${cdnAsset("website-images/email/beta-invite-03.png")}" style="width:100%;height:auto;object-fit:cover;margin-top:40px;display:block;border:0" />
          ...
          <img alt="Primeshot" src="${cdnAsset("website-images/email/base-primeshot-footer-logo.png")}" style="width:140px;height:auto;margin:0 auto 40px auto;display:block;border:0" />
          ...
          <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="text-align:center;margin-bottom:24px"><tbody><tr><td>
            <a href="https://x.com/primeshotai" style="display:inline-block;margin:0 8px;text-decoration:none" target="_blank"><img alt="X" src="${cdnAsset("website-images/email/base-icon-x.png")}" style="width:24px;height:24px;object-fit:cover;display:block;border:0" /></a>
            <a href="https://instagram.com/primeshotai" style="display:inline-block;margin:0 8px;text-decoration:none" target="_blank"><img alt="Instagram" src="${cdnAsset("website-images/email/base-icon-ig.png")}" style="width:24px;height:24px;object-fit:cover;display:block;border:0" /></a>
            <a href="https://linkedin.com/company/primeshotai" style="display:inline-block;margin:0 8px;text-decoration:none" target="_blank"><img alt="LinkedIn" src="${cdnAsset("website-images/email/base-icon-ln.png")}" style="width:24px;height:24px;object-fit:cover;display:block;border:0" /></a>
          </td></tr></tbody></table>
