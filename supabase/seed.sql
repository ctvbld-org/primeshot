...
INSERT INTO "public"."style_wardrobes" ("value", "label", "image", "translations", "category") VALUES
	('hoodie', 'Hoodie', 'hoodie.webp', '{"de": {"label": "Kapuzenpullover"}, "es": {"label": "Sudadera con Capucha"}, "fr": {"label": "Sweat à Capuche"}, "it": {"label": "Felpa con Cappuccio"}, "ja": {"label": "パーカー"}, "nl": {"label": "Hoodie"}, "pt": {"label": "Moletom com Capuz"}, "zh": {"label": "连帽衫"}}', 'Casual'),
	('suit-jacket-shirt', 'Suit Jacket/Shirt', 'blazer-shirt.webp', '{"de": {"label": "Anzugjacke/Hemd"}, "es": {"label": "Chaqueta de Traje/Camisa"}, "fr": {"label": "Veste de Costume/Chemise"}, "it": {"label": "Giacca/Camicia"}, "ja": {"label": "スーツジャケット/シャツ"}, "nl": {"label": "Colbert/Overhemd"}, "pt": {"label": "Paletó/Camisa"}, "zh": {"label": "西装外套/衬衫"}}', 'Professional'),
	('shirt', 'Shirt', 'shirt.webp', '{"de": {"label": "Hemd"}, "es": {"label": "Camisa"}, "fr": {"label": "Chemise"}, "it": {"label": "Camicia"}, "ja": {"label": "シャツ"}, "nl": {"label": "Overhemd"}, "pt": {"label": "Camisa"}, "zh": {"label": "衬衫"}}', 'Professional'),
	('polo', 'Polo', 'polo.webp', '{"de": {"label": "Poloshirt"}, "es": {"label": "Polo"}, "fr": {"label": "Polo"}, "it": {"label": "Polo"}, "ja": {"label": "ポロシャツ"}, "nl": {"label": "Polo"}, "pt": {"label": "Polo"}, "zh": {"label": "polo衫"}}', 'Smart Casual'),
	('henley', 'Henley', 'henley.webp', '{"de": {"label": "Henley"}, "es": {"label": "Henley"}, "fr": {"label": "Henley"}, "it": {"label": "Henley"}, "ja": {"label": "ヘンリーネック"}, "nl": {"label": "Henley"}, "pt": {"label": "Henley"}, "zh": {"label": "亨利领"}}', 'Casual'),
	('jacket', 'Jacket', 'jacket.webp', '{"de": {"label": "Jacke"}, "es": {"label": "Chaqueta"}, "fr": {"label": "Veste"}, "it": {"label": "Giacca"}, "ja": {"label": "ジャケット"}, "nl": {"label": "Jas"}, "pt": {"label": "Jaqueta"}, "zh": {"label": "夹克"}}', 'Layered Looks'),
	('fishermans-jumper', 'Fishermans Jumper', 'fishermans-jumper.webp', '{"de": {"label": "Fischerpullover"}, "es": {"label": "Suéter de Pescador"}, "fr": {"label": "Pull Marin"}, "it": {"label": "Maglione da Pescatore"}, "ja": {"label": "フィッシャーマンセーター"}, "nl": {"label": "Visserstrui"}, "pt": {"label": "Suéter de Pescador"}, "zh": {"label": "渔夫毛衣"}}', 'Casual');
