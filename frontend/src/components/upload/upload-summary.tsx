      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-medium">{t('fields.quality.score')}</h3>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span>{t('fields.images.total')}</span>
              <span>{totalFiles}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span>{t('fields.images.accepted')}</span>
              <span className="text-green-600">{acceptedFiles.length}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span>{t('fields.images.needsImprovement')}</span>
