...
const requirements = [
  {
    text: "Use natural light by standing near a window or going outside.",
    icon: "sun"
  },
  {
    text: "Include both close-up and waist-up photos.", 
    icon: "crop"
  },
  {
    text: "Keep your expression neutral or naturally friendly.",
    icon: "smilyFace"
  },
  {
    text: "Avoid filters, hats, heavy makeup, or AI-generated images.",
    icon: "insights"
  },
  {
    text: "Wear plain clothing with solid colors or soft patterns.",
    icon: "tshirt"
  },
  {
    text: "Upload 8 to 12 different photos with varied angles and lighting.",
    icon: "multitask"
  }
] as const;
...
const dodonts = [
  {
    text: "Look at the camera with your eyes clearly visible.",
  ...
  {
    text: "Use bright, natural lighting. Avoid dark or blurry photos.", 
  ...
  {
    text: "Make sure you're alone in the frame, with no clutter or other people.",
  ...
  {
    text: "Frame your face so it's not too small or cut off.",
  ...
  return (
    <>
      <Button
        ...
        type="button"
        aria-label="View photo requirements"
      >
        Photo Requirements
      </Button>
            ...
            <div className={cn(styles.container, allImagesLoaded && styles.visible)}>
              <div className={styles.header + " " + styles.section}>
                <div className={styles.leftSide}>
                  ...
                  <h2 className={styles.headerTitle}>Photo Requirements</h2>
                </div>
                <div className={styles.rightSide}>
                  <h2 className={styles.headerHeading}>
                    Quick tips for flawless <br /><span className={styles.headerHeadingHighlight}>AI headshots</span>
                  </h2>
                  <p className={styles.headerDescription}>Better photo quality and more variety lead to better headshots. Natural lighting and relaxed expressions make all the difference.</p>
                </div>
              </div>
              ...
              <div className={styles.section}>
                <div className={styles.sticky + " " + styles.leftSide}>
                  <h2 className={styles.requirementsSideHeading}>Follow these photo tips for better results</h2>
                </div>
              ...
              <div className={styles.tipBox}>
                ...
                <p className={styles.tipText}>Natural light, facial variety, and clear framing help the AI create more accurate, professional results.</p>
              </div>

              <div className={styles.section}>
                <div className={styles.sticky + " " + styles.leftSide}>
                  <h2 className={styles.requirementsSideHeading}>What works well and what doesn't</h2>
                </div>
                  ...
                  {dodonts.map((dodont, index) => (
                    <div key={index} className={styles.dodontItem}>
                      <div className={styles.dodontHeader}>
                        ...
                        <span className={styles.dodontText}>{dodont.text}</span>
                      </div>
